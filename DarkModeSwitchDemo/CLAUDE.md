...
- **Entitlements File**: `Config/DarkModeSwitchDemo.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/DarkModeSwitchDemo.entitlements`:
